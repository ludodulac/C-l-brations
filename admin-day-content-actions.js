...
editDay=function(key){
  ...
  document.getElementById('saveDay').onclick=()=>{
    if(d.label==='Préparation'){
      ...
      if(s&&e&&e<s)return toast('La date de fin doit suivre la date de début');
    ...
    saveState(state);editDay(key);toast('Étape enregistrée');
  };
};