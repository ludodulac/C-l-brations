(function(){
  ...
  if(testMode){
    ...
    const showBanner=()=>{
      ...
      const b=document.createElement('div');b.id='participantTestBanner';
      ...
      document.getElementById('quitParticipantTest').onclick=()=>{
        const token=sessionStorage.getItem(TEST_BACKUP_TOKEN)||'',profile=sessionStorage.getItem(TEST_BACKUP_PROFILE)||'';
        ...
        sessionStorage.removeItem(TEST_BACKUP_TOKEN);sessionStorage.removeItem(TEST_BACKUP_PROFILE);location.href='admin.html';
      };
    };
