...
eventHtml=function(e){
  ...
  const extra=`<div class="resources" style="margin-top:10px">${links.map(l=>`<a class="resource-link" href="${esc(l.url)}" target="_blank" rel="noopener">Voir le lien</a>`).join('')}</div>`;
